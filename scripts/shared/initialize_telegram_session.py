"""Create a Telethon session inside a Docker service interactively."""
...
SESSION_PATH = Path(
    os.getenv("TELEGRAM_SESSION_PATH", str(BACKEND_DIR / "session_monitor"))
)
SESSION_MARKER_PATH = (
...
def start_interactive(client: TelegramClient) -> None:
    while True:
        raw_phone = input("Telegram phone (09xxxxxxxx or +8869xxxxxxxx): ")
        ...
        try:
            ...
            print("Telegram rejected the phone number. Please check the country code.")
