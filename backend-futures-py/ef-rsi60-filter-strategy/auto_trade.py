"""Verified Shioaji execution adapter for the RSI60-filtered EF strategy.

The broker reconciliation code is shared with H3+EF, while this adapter logs
in with API_KEY2 so RSI60 uses the former strong-consensus futures account.
"""
...
def _load_shared_adapter():
    module_name = "_h3_ef_012_auto_trade_shared_for_rsi60"
...
def execute_target_position(
    ...
    *,
    ...
    """Reconcile API_KEY2's real TMF position to the full RSI net target."""
    if api is not None:
